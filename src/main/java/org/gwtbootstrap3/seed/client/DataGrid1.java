...
public class DataGrid1 extends Composite  {

	private static DataGrid1UiBinder uiBinder = GWT.create(DataGrid1UiBinder.class);

	interface DataGrid1UiBinder extends UiBinder<Widget, DataGrid1> {
	}
